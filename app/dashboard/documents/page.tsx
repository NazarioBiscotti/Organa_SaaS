...
export default async function DocumentsPage({ searchParams }: Props) {
  ...
  const selectedAreaId = areaId ? Number(areaId) : undefined;
  ...
  return (
    <main>
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-semibold mb-5">Create a new document</h2>
        ...
        >
          ...
          {selectedArea ? (
            <>
              <input type="hidden" name="area" value={selectedArea.id} />
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-5">All Documents</h2>
        ...
        {documents.length === 0 ? (
          <div className="border rounded p-8">
            ...
            <p className="mt-2 text-neutral-500">
              Create your first document to start organizing your knowledge.
            </p>
          </div>
        ) : (
          <div className="grid gap-5">
            {documents.map((document) => (
              <div key={document.id} className="border rounded p-5">
                <Link
